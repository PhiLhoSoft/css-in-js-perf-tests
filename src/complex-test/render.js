...
function renderComponent(index, classNames, appData) {
    return `<div class="${classNames.component}">
...
function renderComponents(classNames, appData) {
    const components = [];

    for (let i = 0; i < appData.itemNumber; i++) {
        components.push(renderComponent(i, classNames, appData));
    }
...
export const renderBody = (libraryName, classNames, appData) => {
    return `<header class="${classNames.top}">
    <h1>${libraryName}</h1>
</header>
<div class="container">
    <!-- TODO -->
    <section class="${classNames.container}">
        <header class="${classNames.title}">
            <h2>Main app</h2>
        </header>
${renderComponents(classNames, appData)}
...
<footer class="${classNames.bottom}">
